    ...
    React.useEffect(() => {
        ...
        if (query.trim()) {
            ...
            filtered = filtered.filter((s) => {
                var _a, _b;
                const nameHit = (_a = s.space.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(q);
                const idHit = (_b = s.space.id) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(q);
                return nameHit || idHit;
            });
        }
        // multi type filter
        if (config === null || config === void 0 ? void 0 : config.enableFilterByType) {
            const activeTypes = selectedTypes.includes("") ? [] : selectedTypes; // "" == All Types
            if (activeTypes.length) {
                filtered = filtered.filter((s) => {
                    var _a;
                    const t = (_a = s.space.type) !== null && _a !== void 0 ? _a : "";
                    return activeTypes.includes(t);
                });
            }
        }
        setFilteredSpaceRegions(filtered || []);
    }, [allSpaceRegions, query, selectedTypes, config === null || config === void 0 ? void 0 : config.enableFilterByType]);
