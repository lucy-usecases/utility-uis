...
const SensorSpaceCoordinateEditor = (props) => {
    ...
    const saveSpace = React.useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const res = yield ((_f = props.uxpContext) === null || _f === void 0 ? void 0 : _f.executeAction(model, action, { floorId: selectedFloor, space: newSpace }, { json: true }));
            loadSpaces();
    ...
    const saveRegionChanges = React.useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            yield ((_g = props.uxpContext) === null || _g === void 0 ? void 0 : _g.executeAction(model, action, params, { json: true }));
            yield loadSpaces();
    ...
    return (React.createElement("div", { className: "location-marker-ui-container" },
        React.createElement("div", { className: "lmui-sidebar" },
            ...
            React.createElement("div", { className: "content" },
                ...
                React.createElement("div", { className: "footer" }, hasValue((_b = config === null || config === void 0 ? void 0 : config.addSpace) === null || _b === void 0 ? void 0 : _b.model) && hasValue((_c = config === null || config === void 0 ? void 0 : config.addSpace) === null || _c === void 0 ? void 0 : _c.action) &&
        ...
        React.createElement("div", { className: "lmui-map-container" }, (selectedFloorData === null || selectedFloorData === void 0 ? void 0 : selectedFloorData.layout.floorPlan) ? (React.createElement(React.Fragment, null,
            ...
            selectedSpace && (React.createElement("div", { className: "toolbar" },
                ...
                isEditingRegion && (React.createElement("div", { className: "coordinates-list" },
                    React.createElement("div", { className: "coordinates-list-header" }, "Coordinates"),
                        ...
                        React.createElement("table", null,
                            ...
                            React.createElement("tbody", null, region.map((coord, index) => (React.createElement("tr", { key: index, className: "coordinate-container" },
                                ...
                                React.createElement("td", null,
                                    React.createElement(components_1.Input, { type: "number", value: coord.x.toString(), onChange: (value) => handleCoordinateChange(index, 'x', value), placeholder: "X", className: "coordinate-input" })),
                                React.createElement("td", null,
                                    React.createElement(components_1.Input, { type: "number", value: coord.y.toString(), onChange: (value) => handleCoordinateChange(index, 'y', value), placeholder: "Y", className: "coordinate-input" })),
